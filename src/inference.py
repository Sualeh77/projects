...
from src.config.base_config import DATASET, DEVICE, TRAINING, CHECKPOINTS_DIR, LOGS_DIR, EXPERIMENTS
from src.models.get_model import get_model
import os
import json
import argparse

def run_inference_experiment(exp_id, hyperparameters_experiment_id, save_predictions):
...
def main():
    ...
    run_inference_experiment(args.exp_id, args.hyperparameters_experiment_id, args.save_predictions)
